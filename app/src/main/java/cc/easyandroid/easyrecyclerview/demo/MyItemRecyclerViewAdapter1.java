 ...
 */
public class MyItemRecyclerViewAdapter1 extends RecyclerView.Adapter<MyItemRecyclerViewAdapter1.ViewHolder> {

    private final List<DummyItem> mValues;
    private final OnListFragmentInteractionListener mListener;

    public MyItemRecyclerViewAdapter1(List<DummyItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
