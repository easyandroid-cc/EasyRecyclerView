 ...
 */
public class MyHolder_Expand2 extends AbstractExpandableItem implements IHeader {


    public MyHolder_Expand2() {
        List<IFlexible> items = new ArrayList<IFlexible>();
        for (int i = 0; i < 5; i++) {
            items.add(new MyHolder(i + 12000 + hashCode()));
        }
    ...
    public int getLayoutRes() {
        return R.layout.fragment_item_expand2;
    }
